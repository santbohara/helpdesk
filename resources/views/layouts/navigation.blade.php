    ...
    <div class="px-3">
        ...
        <div class="flex justify-between items-center h-16">
            ...
            <div class="flex gap-2 items-center">
                ...
                <a href="{{ route('dashboard') }}" class="text-gray-400 text-xs mt-1 hover:text-indigo-500">
            ...
            <div class="flex">
                ...
                <div class="flex justify-end">
                    <button id="theme-toggle" type="button"
                        class="text-gray-500 dark:text-gray-300 hover:bg-gray-300 border-gray-300 dark:border-gray-700 dark:hover:text-gray-300 dark:hover:bg-gray-700
