...
<form wire:submit.prevent="submit" class="border p-6 rounded-md shadow-md">
    ...
    @if (session()->has('success'))
        <div class="bg-teal-100 border border-t-4 mb-6 border-teal-500 rounded text-teal-900 px-4 py-3" role="alert">
            <div class="flex">
                <div class="py-1">
    ...
    <button type="submit"
            ...
            data-action='submit'
        class="g-recaptcha text-white bg-blue-700 hover:bg-blue-800
